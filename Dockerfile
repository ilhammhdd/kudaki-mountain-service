...
WORKDIR /go/src/github.com/ilhammhdd/kudaki-mountain-service/
COPY . /go/src/github.com/ilhammhdd/kudaki-mountain-service/
RUN dep ensure
RUN go build -o kudaki_mountain_service_app
